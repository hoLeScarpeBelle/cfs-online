...
public class Game_window extends JPanel 
{
    ...
    private JLabel p1Choice_label,p2Choice_label,action_label,p1Point_label,p2Point_label,round_label;
    private JButton paper_botton,rock_button,scissor_button;
    private time_thread timeTh;
    ...
    public Game_window(Window parent)
    {
        ...
        //selection panel
        action_label = new JLabel("scegli cosa buttare", (int) JLabel.CENTER_ALIGNMENT);
        ...
        this.round_label = new JLabel("round 1");
        
        infoPanel.add(this.p1Point_label);
        infoPanel.add(Box.createHorizontalGlue());
        infoPanel.add(this.round_label);
        infoPanel.add(Box.createHorizontalGlue());
    ...
    public Game_window(String sessionName, String operation  , Window parent)
    {
        //setBackground(Color.GREEN);
        this.parent = parent;
        SpringLayout layout = new SpringLayout();
        setLayout(layout);
        SockClient sock = new SockClient(sessionName, operation, this);
        ...
        p2Choice_label = new JLabel("p2", (int) JLabel.CENTER_ALIGNMENT);
        JLabel time_label = new JLabel("00:00", (int) JLabel.CENTER_ALIGNMENT);
        timeTh = new time_thread(time_label);
        timeTh.start();
        time_label.setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.BLACK));
        ...
        paper_botton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) 
            {
                ...
                disableAllButton();
                sock.sendMsg("0");
                setActionLabel("aspetto la risposta di p2");
            }
        });
        scissor_button = new JButton("forbice");
        scissor_button.addActionListener(new ActionListener() {
    ...
    public void showAllertMessage(String msg)
    {
    ...
    public void goBack()
    {
        try {
            ...
            Logger.getLogger(Game_window.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    {
        return this.parent.getLoggedUser();
    }
    
    public void setRoundLabel(int x)
    {
        this.round_label.setText("round " + x);
    }
}
